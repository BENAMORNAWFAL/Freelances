            ...
            <div className="container-fluid pt-5 bg-footer">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    ...
                                    <li><a href="#">BenArous</a></li>
                                    <li><a href="#">Bizert</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    ...
                                    <li><a href="#">Mechouia salad</a></li>
                                    <li><a href="#">Mloukhia</a></li>
                                    <li><a href="#">Osbane</a></li>
                                    <li><a href="#">Brik</a></li>
                                    <li><a href="#">Ojja</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    <li className="pb-3">
                                        ...
                                        <span>+216 33 333 333</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                            <FontAwesomeIcon icon="envelope" className="text-white" />
                                        </span>
                                        <span>info@deliveryfood.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2019 Delivery Food. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>IKBEL SOUELMI</span></p>
                    </div>
                </div>
            </div>
        );
